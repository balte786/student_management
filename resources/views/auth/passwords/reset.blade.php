                    ...
                    <div class="p-4">
                        ...
                        <form method="POST" action="{{ route('password.update') }}">
                            ...
                            <div class="form-group">
                                ...
                                <input id="email" type="email" class="form-control form-control @error('email') is-invalid @enderror" name="email" value="{{ $email ?? old('email') }}" required autocomplete="email" autofocus>
                                @error('email')
                            ...
                            <button type="submit" class="btn btn btn-primary btn-block mt-2">{{ __('Reset Password') }}</button>
                        </form>
                    </div>
                </div>
