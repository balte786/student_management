...
@section('content')
    ...
    <div class="main-content">
        <div class="breadcrumb">
            <h1 class="mr-2">Obafemi Awolowo University Ile-Ife</h1>
            <ul>
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12">
                ...
                <div class="card text-left">
                    ...
                    <div class="card-body">
                        <h4 class="card-title mb-3">Approved Index Numbers for 2021</h4>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @else
                                            ...
                                            <button class="btn btn-primary btn-icon m-1" type="button"><span class="ul-btn__text">NOT FOUND</span></button>
