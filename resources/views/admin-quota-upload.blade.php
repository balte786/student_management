    ...
    <div class="main-content">
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12">
                ...
                <hr>
                <a href="admin-quota-upload.php"><button class="btn btn-primary" type="button">ADD NEW YEARLY QUOTA</button></a>
                <hr>
                <!--begin::form-->
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12 col-md-12">
                                        ...
                                        <form action="{{ URL::to('admin/admin-quota-upload') }}" method="POST" enctype="multipart/form-data">
                                            @csrf
                                            <div class="row">
                                                ...
                                                <div class="col-md-4 form-group mb-3 input-group">
                                                    ...
                                                    <select name="category_id" class="form-control" >
                                                        <option selected>Institution Category</option>
