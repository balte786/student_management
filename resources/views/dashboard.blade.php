                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6">
                        <div class="card card-icon mb-4">
                            <div class="card-body text-center"><i class="i-Diploma-2"></i>
                                ...
                                <p class="text-primary text-50 line-height-1 m-0">{{ SchoolController::fetchTotalCountsUniversity('1','category_id'); }}</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-6">
                        <div class="card card-icon mb-4">
                            <div class="card-body text-center"><i class="i-Student-MaleFemale"></i>
                                ...
                                <p class="text-primary text-50 line-height-1 m-0">{{ AdminController::fetchTotalStudentCounts('0','status'); }}</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-6">
